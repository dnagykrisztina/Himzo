  ...
  template: `
    <div>
      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="indexMember.html">{{ titleHimzo }}</a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item">
              <a class="nav-link" href="indexMember.html">{{ order }} </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="userOrderMember.html">{{ myOrders }}</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="allOrderMember.html">{{ allOrder }}</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="aboutUsMember.html">{{ aboutUs }}</a>
            </li>
            <li class="dropdown nav-item">
              <a href="#" class="dropbtn nav-link">{{ username }}</a>
              <div class="dropdown-content">
                <a href="profileMember.html">{{ profile }}</a>
...
var app = new Vue({
  ...
  data: {
    ...
    aboutUsTitle: "Pulcsi és FoltMéKör",
    title_description:
      "Mi, a Pulcsi és FoltMékör, tevékenységünkkel próbáljuk elősegíteni, hogy a Schönherzes rendezvények rendezői, résztvevői és a körök tagjai egy több 10 év múlva is megmaradó emlékekkel gazdagodhassanak.",
    job_description:
  ...
  variants: [
    {
      variantId: 0,
      variantImage: "./images/picture.jpg"
    },
    {
      variantId: 1,
      variantImage: "./images/picture.jpg"
